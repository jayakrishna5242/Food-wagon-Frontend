            ...
            >
              ...
              <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-3xl p-8 text-white relative overflow-hidden">
                <div className="relative z-10 max-w-lg">
                  <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight">Anything Delivered Instantly</h2>
            ...
            >
              ...
              <div className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
                <div className="p-8 md:p-10">
                  <div className="mb-10">
                    <h2 className="text-3xl font-black text-dark uppercase tracking-tight mb-2">
                  ...
                  {isSuccess ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                      <div className="space-y-6">
                        <div className="relative">
                          <div className="flex items-center justify-between ml-1 mb-3">
                            ...
                            <button 
                              ...
                              className="flex items-center gap-1.5 text-[10px] font-black text-primary hover:text-orange-600 transition-colors uppercase tracking-widest"
                            >
                        ...
                        <div className="relative">
                          <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1 mb-3 block">Drop-off Location</label>
                          <div className="relative">
                        ...
                        <div className="relative">
                          <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1 mb-3 block">Item Description</label>
                          <textarea 
